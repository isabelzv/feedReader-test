# Jasmine Test Automation with Jasmine

## Summary

The task was to create a series of test suites that would provide end-to-end testing of a RSS Feed Reader web application.
